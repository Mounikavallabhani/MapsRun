...
public class GetAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        if (location == null) {
            ...
            sendResultsToReceiver(0, msg,latitude,langutude);
            return;
        }
        ...
        try {
            ...
            langutude=location.getLongitude();
        ...
        if (addresses == null || addresses.size()  == 0) {
            ...
            sendResultsToReceiver(1, msg,latitude,langutude);
        } else {
...
/*
            ...
            sendResultsToReceiver(2,addressDetails.toString(), latitude, langutude);
        }
    }
    //to send results to receiver in the source activity
    private void sendResultsToReceiver(int resultCode, String message,Double latitude,Double langutude) {
        Bundle bundle = new Bundle();
        bundle.putString("address_result", message);
        bundle.putString("latitude", ""+latitude);
        bundle.putString("langutude", ""+langutude);
